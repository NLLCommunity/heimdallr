...
func AdminGatekeepMessageModalHandler(e *handler.ModalEvent) error {
	...
	if err != nil {
		return CreateMessage(e, true, "The message contains data that is invalid; this may be caused by invalid placeholders.")
	}
	...
	return CreateMessage(e, true, "Gatekeep approved message updated.")
}
...
func AdminJoinMessageModalHandler(e *handler.ModalEvent) error {
	...
	return CreateMessage(e, true, "Join message updated.")
}
...
func AdminLeaveMessageModalHandler(e *handler.ModalEvent) error {
	...
	return CreateMessage(e, true, "Leave message updated.")
}
